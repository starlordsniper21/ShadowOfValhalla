...
public class DwarfV2 : MonoBehaviour
{
    ...
    public GameObject DwarfAttackArea;
    ...
    private void Start()
    {
        ...
        DwarfAttackArea.SetActive(false);
    }
    ...
    private void Update()
    {
        ...
        if (distanceToPlayer <= detectionRadius)
        {
            ...
            if (!preparing)
            {
                ...
                // run animation 
                animator.SetBool("IsRunningDwarf", true);
            }
            ...
            if (animator.GetCurrentAnimatorStateInfo(0).IsName("DwarfAttack") && animator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1.0f)
            {

                DwarfAttackArea.SetActive(true);
        ...
        else
        {
            ...
            animator.SetBool("IsRunningDwarf", false);
        }
    }
